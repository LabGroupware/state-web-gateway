...
public class RelationRetrieverBuilder<T extends DomainDto & DeepCloneable, U extends DomainDto, V extends Retriever<? super T>> {
    ...
    public static <T extends DomainDto & DeepCloneable, U extends DomainDto, V extends Retriever<? super T>> RelationRetrieverBuilder<T, U, V> builder() {
